...
- [ComposeDialog.module.css](./ComposeDialog.module.css): 发帖弹窗样式模块，封装 header/body/footer、表单输入与高级输入区域
...
- [HotkeyHelpDialog.module.css](./HotkeyHelpDialog.module.css): 快捷键帮助弹窗样式模块，封装列表、按键标签与关闭按钮
- [HotkeyHelpDialog.tsx](./HotkeyHelpDialog.tsx): 快捷键帮助弹窗内容
- [SearchDialog.module.css](./SearchDialog.module.css): 搜索弹窗样式模块，封装输入区、结果卡片与空态
...
- [TriggerButton.module.css](./TriggerButton.module.css): 发起讨论按钮样式模块，封装内部渐变与流光动效
